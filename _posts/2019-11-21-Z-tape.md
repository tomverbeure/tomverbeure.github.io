...
of statistics at work: 48 IOs that are each 30x smaller than specified. What if we reduce the number of IOs and
increase the size of the pads?
...
are specified as a range, but 0.5mm x 1.00mm or 0.5mm2 is a good ballpark number, about 5 times larger than our NOR flash, though 
...
a board and thus it doesn't work in that capacity either.
...
Still, this was a fun experiment to fill Friday evening. My remaining 14 3/4 sheet of Z-tape will go back into
the bag and will find a warm and cozy box full of development boards, waiting to be used for some future project.
