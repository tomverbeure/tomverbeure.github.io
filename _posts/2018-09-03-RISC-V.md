...
It tooks a while before I figured it out, but there was a bug in the wrapper code. I forgot the exact details, but the net result
was that, due to a typo, the formal test was accidentally guided into avoiding hangs. That's not a smart idea when checking
for 
