...
[![AMIQ frontside view](/assets/amiq/teardown/amiq_frontside.jpg)](/assets/amiq/teardown/amiq_frontside.jpg)
*(Click to enlarge)*
...
[![AMIQ backside view](/assets/amiq/teardown/amiq_backside.jpg)](/assets/amiq/teardown/amiq_backside.jpg)
*(Click to enlarge)*
...
![Oscilloscope showing a constellation diagram generated by an AMIQ](/assets/amiq/teardown/amiq_const_diagram.jpg)
...
![WinIQSIM - AMIQ - SMIQ setup](/assets/amiq/teardown/amiq_smiq_setup.png)
...
[![AMIQ block diagram](/assets/amiq/teardown/amiq_block_diagram.png)](/assets/amiq/teardown/amiq_block_diagram.png)
*(Click to enlarge)*
...
[![Backside speciality connectors](/assets/amiq/teardown/backside_connectors.jpg)](/assets/amiq/teardown/backside_connectors.jpg)
*(Click to enlarge)*
...
[![Backside PC connectors](/assets/amiq/teardown/backside_pc_connectors.jpg)](/assets/amiq/teardown/backside_pc_connectors.jpg)
*(Click to enlarge)*
...
[![WinIQSim Main Multi-Carrier window](/assets/amiq/teardown/AMIQ_Main_Multi_Carrier_window.png)](/assets/amiq/teardown/AMIQ_Main_Multi_Carrier_window.png)
*(Click to enlarge)*
...
[![WinIQSim FFT Magnitude plot window](/assets/amiq/teardown/AMIQ_Graphics_window.png)](/assets/amiq/teardown/AMIQ_Graphics_window.png)
...
* the top contains all the components of a standard PC
  ...
  [![AMIQ top inside view - PC motherboard](/assets/amiq/teardown/amiq_pc_motherboard_side.jpg)](/assets/amiq/teardown/amiq_pc_motherboard_side.jpg)
  *(Click to enlarge)*


* the bottom has a signal generation PCB

  [![AMIQ signal generation side](/assets/amiq/teardown/amiq_siggen_side.jpg)](/assets/amiq/teardown/amiq_siggen_side.jpg)
  *(Click to enlarge)*
...
[![AMIQ signal generation board](/assets/amiq/teardown/amiq_siggen_uncovered.jpg)](/assets/amiq/teardown/amiq_siggen_uncovered.jpg)
*(Click to enlarge)*
...
[![AMIQ signal generation annotated](/assets/amiq/teardown/amiq_siggen_annotated.jpg)](/assets/amiq/teardown/amiq_siggen_annotated.jpg)
*(Click to enlarge)*
...
[![Block diagram example](/assets/amiq/teardown/block_diagram.png)](/assets/amiq/teardown/block_diagram.png)
...
[![Schematic signal references](/assets/amiq/teardown/schematic_signal_references.png)](/assets/amiq/teardown/schematic_signal_references.png)
...
![AMIQ test connectors](/assets/amiq/teardown/amiq_test_connectors.jpg)
...
a [Milliren Technologies 453-0210](/assets/amiq/teardown/milliren_txco_400_series.jpg).

![Reference clock generation PCB](/assets/amiq/teardown/ref_clock_generation_pcb.jpg)
...
[![Reference clock block diagram](/assets/amiq/teardown/reference_clock_diagram.png)](/assets/amiq/teardown/reference_clock_diagram.png)
<center>Schematic page 5 <i>(Click to enlarge)</i></center><br/>
...
[![Clock synthesizer block diagram](/assets/amiq/teardown/clock_synthesizer.png)](/assets/amiq/teardown/clock_synthesizer.png)
<center>Schematic page 5 <i>(Click to enlarge)</i></center><br/>
...
[![Clock synthesizer PCB](/assets/amiq/teardown/clock_synthesizer_pcb.jpg)](/assets/amiq/teardown/clock_synthesizer_pcb.jpg)
*(Click to enlarge)*
...
![AD9850 block diagram](/assets/amiq/teardown/ad9850_block_diagram.png)

The signal flow inside the AD9850 is interesting:

![AD9850 signal flow](/assets/amiq/teardown/ad9850_signal_flow.png)
...
[![DDS oscillator schematic](/assets/amiq/teardown/dds_oscillator.png)](/assets/amiq/teardown/dds_oscillator.png)
...
![Filter schematic in LTspice](/assets/amiq/teardown/filter_spice_schematic.png)

The filter has a cut-off frequency of around 13 MHz:

[![Filter frequency plot in LTspice](/assets/amiq/teardown/filter_spice_frequency_plot.png)](/assets/amiq/teardown/filter_spice_frequency_plot.png)
...
![DAC system diagram](/assets/amiq/teardown/clock_skew_tuning-amiq_system_diagram.svg)

Here's what the skewing circuit looks like:

[![Skew adjust schematic](/assets/amiq/teardown/skew_adj_schematic.png)](/assets/amiq/teardown/skew_adj_schematic.png)
<center>Schematic page 10 <i>(Click to enlarge)</i></center><br/>
...
![Oscilloscope pictures of skewed purple and yellow signals](/assets/amiq/teardown/skew_purple_vs_yellow.jpg)
...
![Variable gain amplifier](/assets/amiq/teardown/variable_gain_unit.png)
...
[![Output path block diagram](/assets/amiq/teardown/output_path_block_diagram.png)](/assets/amiq/teardown/output_path_block_diagram.png)
<center>Schematic page 3 <i>(Click to enlarge)</i></center><br/>

Let's check out the details!

![ADC835 PCB](/assets/amiq/teardown/ad835_pcb.jpg)
...
[![Variable gain amplifier](/assets/amiq/teardown/variable_gain_amplifier.png)](/assets/amiq/teardown/variable_gain_amplifier.png)
...
![AD835 functional block diagram](/assets/amiq/teardown/ad835_block_diagram.png)
...
[![Diagnostic circuit schematic](/assets/amiq/teardown/diagnostics_adc.jpg)](/assets/amiq/teardown/diagnostics_adc.jpg)
...
[![Diagnostics peak and phase detection circuits](/assets/amiq/teardown/diagnostics_peak_recorder.png)](/assets/amiq/teardown/diagnostics_peak_recorder.png)
<center>Schematic page 14 <i>(Click to enlarge)</i></center><br/>
...
[![Configuration scan chain](/assets/amiq/teardown/config_scan_chain.png)](/assets/amiq/teardown/config_scan_chain.png)
