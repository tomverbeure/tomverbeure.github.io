...
something that's relatively easy to do, but a few well-placed booby-traps turned it into something that took
...
Both the `pyvisa` [`read()`](https://pyvisa.readthedocs.io/en/latest/api/resources.html#pyvisa.resources.MessageBasedResource.read)
