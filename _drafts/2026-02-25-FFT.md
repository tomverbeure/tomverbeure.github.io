...
![DFT-8 DIT as 2 DFT-4](/assets/fft/FFT-DIT_2xDFT4.svg)
...
* [Spectrum and spectral density estimation by the Discrete Fourier transform (DFT), including a comprehensive list of window functions and some new flat-top windows](/assets/fft/GH_FFT.pdf)
...
* [The Fast Fourier Transform in Hardware: A Tutorial Based on an FPGA Implementation](/assets/fft/FFTtutorial121102.pdf)

* [A Survey on Pipelined FFT Hardware Architectures](/assets/fft/s11265-021-01655-1.pdf) 
