...
* Texas Instruments PCI-1225 CardBus Controller
  ...
  Windows installed the default PCI-1225 driver for this, but that one doesn't
...
* Chips and Technologies 69000 video driver
  ...
  in the TekScope application. For that, you need the Chips and Technologies
  (Asiliant) 69000 driver.

There is a GitHub repo with a bunch of TDS7000-series software, including this 
[Drivers](https://github.com/exit-failure/tds7000/tree/main/Drivers) directory.
The README.md says that the driver *should work* for Windows 98 and XP, but only
some of them worked for Win2k Pro: the C&T video driver definitely did not!

I used [Driver Collector](https://www.majorgeeks.com/files/details/driver_collector.html)
to extract the video driver from the original hard drive and that worked fine.
